...
public class MessageCollector {
	...
	public MessageCollector(boolean ignore, boolean batching) {
		this.ignoreNonRelatedEvents = ignore;
	...
	public void newMessage(NotificationMessage message) {
		if (this.ignoreNonRelatedEvents) {
			...
			this.listener.newMessageForFeature(message, identifyFeature(message));
		}
	}

	private String identifyFeature(NotificationMessage message) {
