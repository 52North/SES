...
public class LatestEventMessageCollector implements MessageListener {
	...
	public synchronized NotificationMessage pullMessage() {
		NotificationMessage result = this.latestMessage;
		this.latestMessage = null;
		return result;
	}

	@Override
	public synchronized void newMessageForFeature(NotificationMessage message, String feature) {
		
	}

	@Override
	public synchronized void newMessage(NotificationMessage message) {
