...
//					this.selectString = "(input.observedProperty * -1) as value";
			...
			else if (this.functionName.equals(DynamicSpatialBufferView.SELECTFUNCTION_NAME)) {
				/*
				 * THE dynamic buffer for OWS-8+
				 */
				this.selectString = DynamicSpatialBufferView.SELECT_STRING;
				this.allowOriginalMessageAsResult = DynamicSpatialBufferView.ALLOW_ORIGINAL_MESSAGE;
			}
			/*
