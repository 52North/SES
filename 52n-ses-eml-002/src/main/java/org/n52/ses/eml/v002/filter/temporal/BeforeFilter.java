...
/**
 * Temporal filter checking the temporal 'before' condition.
 *
 */
public class BeforeFilter extends ATemporalFilter {

	private static final Logger logger = LoggerFactory
			.getLogger(BeforeFilter.class);
	 ...
	 */
	public BeforeFilter(TemporalOpsType temporalOps) {
		super(temporalOps);
	}
