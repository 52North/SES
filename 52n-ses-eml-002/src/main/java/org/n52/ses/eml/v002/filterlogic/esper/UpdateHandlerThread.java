...
public class UpdateHandlerThread implements Runnable {
	...
	@Override
	public void run() {
		UpdateHandlerThread.logger.debug("Update received for statement: " + this.statement.getStatement());
...
//		}
		...
		try {
			...
			if (this.doOutput) {
				UpdateHandlerThread.logger.debug("performing output for this match");
