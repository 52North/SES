...
/**
 * Exception in case unit conversion failed.
 * 
 * @author Matthes Rieke <m.rieke@uni-muenster.de>
 * @deprecated replaced by {@link UCUMTools.UnitConversionFailedException}.
 *
 */
public class UnitConversionFailedException extends Exception {
	 ...
	 */
	public UnitConversionFailedException(String text) {
		super(text);
