 ...
 * 
 */
public class LessThanOrEqualToFilter extends ABinaryComparisonFilter {
	 ...
	 */
	public LessThanOrEqualToFilter(BinaryComparisonOpType binaryOp, HashSet<Object> propertyNames) {
